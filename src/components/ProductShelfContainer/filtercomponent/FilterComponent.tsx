  ...
  return (
    <div className={styles["filter-container"]}>
      <FilterButton
        ...
        imgSrc="/assets/images/tshirt_4715759.png"
        altText="tops"
      />
      <FilterButton
        ...
        filter={filter}
        onFilterChange={onFilterChange}
        imgSrc="/assets/images/clothes_16092464.png"
        altText="bottoms"
      />
      <FilterButton
        ...
        filter={filter}
        onFilterChange={onFilterChange}
        imgSrc="/assets/images/parka_3798182.png"
        altText="overwears"
      />
      <FilterButton
        ...
        filter={filter}
        onFilterChange={onFilterChange}
        imgSrc="/assets/images/clothes_12839267.png"
        altText="fullbody"
      />
    </div>
  );
